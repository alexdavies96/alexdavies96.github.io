...
function importJSONfile()
{
    ...
    document.getElementById("portfolio").appendChild(myh1);

    let myh2 = document.createElement('h2');
    myh2.textContent = requestData['homeTown'];
    document.getElementById("portfolio").appendChild(myh2);

    let myh3 = document.createElement('h3');
    myh3.textContent = requestData['formed'];
    document.getElementById("portfolio").appendChild(myh3);

    let myh4 = document.createElement('h4');
    myh4.textContent = requestData['secretBase'];
    document.getElementById("portfolio").appendChild(myh4);

    let myh5 = document.createElement('h5');
    myh5.textContent = requestData['active'];
    document.getElementById("portfolio").appendChild(myh5);
    ...
    for (let j = 0; j < requestData['members'].length; ++j) {
        ...
        document.getElementById("portfolio").appendChild(myh6);
    }
    for (let j = 0; j < requestData['members'].length; ++j) {
        let myh6 = document.createElement('h6');
